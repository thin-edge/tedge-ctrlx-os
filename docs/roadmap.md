...
This document describes features of **thin-edge.io** and the **ctrlX AUTOMATION** platform that are not yet implemented or only partially supported in the current app version (0.1.17).
